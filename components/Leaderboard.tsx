...
import { fetchAccounts } from '../services/googleSheetService.ts';
...
// --- All-Time Leaderboard Component (Placeholder) ---
const AllTimeLeaderboardTab: React.FC = () => {
    return <div className="text-center p-10 text-gray-500">Bảng xếp hạng toàn diện sẽ sớm ra mắt!</div>;
};

// --- Research Leaderboard Component (Placeholder) ---
const ResearchLeaderboardTab: React.FC = () => {
    return <div className="text-center p-10 text-gray-500">Bảng xếp hạng nghiên cứu sẽ sớm ra mắt!</div>;
};

// --- Main Leaderboard Component ---
const Leaderboard: React.FC = () => {
    const [activeTab, setActiveTab] = useState<'weekly' | 'all-time' | 'research'>('weekly');
    
    const tabs = [
        { id: 'weekly', name: 'Thử thách tuần', icon: 'flame', component: <WeeklyLeaderboardTab /> },
        { id: 'all-time', name: 'Toàn diện', icon: 'trophy', component: <AllTimeLeaderboardTab /> },
